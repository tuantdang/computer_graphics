...
def setup_lighting():
    ...
    light_pos = [0, 0, 10.0, 1.0]         # (x,y,z,w): w=1: position, w=0: dir. Positional light
    light_diffuse = [1.0, 1.0, 1.0, 1.0]     # White diffuse light: Color (r,g,b,a)
    light_specular = [1.0, 1.0, 1.0, 1.0]    # White specular light: Color (r,g,b,a)
    light_ambient = [1, 1, 1, 1.0]     # Ambient light: Color (r,g,b,a)
